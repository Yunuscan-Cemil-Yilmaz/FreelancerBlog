...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>{{ isEdit ? 'Edit' : 'Add' }} Education</h2>
    <mat-dialog-content>
      <form [formGroup]="form" class="form-container">
        ...
        <mat-form-field appearance="outline" class="full-width">
          <mat-label>degree_en</mat-label>
          <input matInput formControlName="degree_en">
        </mat-form-field>
        <mat-form-field appearance="outline" class="full-width">
          <mat-label>degree_tr</mat-label>
          <input matInput formControlName="degree_tr">
        </mat-form-field>
        <mat-form-field appearance="outline" class="full-width">
          <mat-label>school_en</mat-label>
          <input matInput formControlName="school_en">
        </mat-form-field>
        <mat-form-field appearance="outline" class="full-width">
          <mat-label>school_tr</mat-label>
          <input matInput formControlName="school_tr">
        </mat-form-field>
        <mat-form-field appearance="outline" class="full-width">
...
export class EducationFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      ...
      degree_en: ['', [Validators.required]],
      degree_tr: ['', [Validators.required]],
      school_en: ['', [Validators.required]],
      school_tr: ['', [Validators.required]],
